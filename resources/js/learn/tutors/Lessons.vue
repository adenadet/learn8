...
<div class="col-12 table-responsive">
    ...
    <div class="modal fade" id="lessonModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body"><LmsFormLesson :editMode="editMode" :lesson="lesson"/></div>
            </div>
        </div>
    </div>
    <div class="card bg-light">
        ...
        <div class="card-body">
<table class="table table-striped table-hover" v-show="lessons != null && lessons.length != 0 &&(typeof lesson != 'undefined')">
    <thead>
        <tr>
            <th>S/N</th>
            <th>Name</th>

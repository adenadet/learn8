...
<div class="col-12 table-responsive">
    ...
    <button class="btn btn-success"  @click="addLesson()">Add New Module</button>
    <table class="table table-striped table-hover">
        ...
        <tbody>
            <tr v-for="lesson in lessons" :key="lesson.id">
                ...
                <td>
                    <div class="btn-group">
                        <button class="btn btn-sm btn-primary" v-on:click="editLesson(lesson)"><i class="fa fa-edit"></i></button>
